...
class LineParamEstimator : public ParameterEsitmator<cv::Point2d,double>
{
public:
	 ...
	 */
	virtual void estimate(std::vector<cv::Point2d *> &data, std::vector<double> &parameters);
	 ...
	 *                   vector is empty (size = 0).
	 */
	virtual void leastSquaresEstimate(std::vector<cv::Point2d *> &data, std::vector<double> &parameters);
	 ...
	 */
	virtual bool agree(std::vector<double> &parameters, cv::Point2d &data);
